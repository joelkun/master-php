...
class Coche{
	...
	// PUBLIC: Podemos accede desde cualquier lugar, dentro de clase actual, dentro de clases que hereden esta clase o fuera de la clase
	public $color;

	// PROTECTED: Podemos acceder desde la clase que los define y desde clases que hereden esta clase
	protected $marca;

	// PRIVATE: uicamente se puede acceder desde esta clase
	private $modelo;
